...
### `WorkOSProviderSettings` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L29" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>


Settings for WorkOS OAuth provider.


### `WorkOSTokenVerifier` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L47" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `verify_token` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L72" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `WorkOSProvider` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L120" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `AuthKitProviderSettings` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L247" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

### `AuthKitProvider` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L260" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_routes` <sup><a href="https://github.com/mengzhisuoliu/fastmcp/blob/main/src/fastmcp/server/auth/providers/workos.py#L343" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
